...
sharpen::ByteBuffer rkv::ClientOperator::GetValue(sharpen::NetStreamChannelPtr channel,sharpen::ByteBuffer key)
{
...
rkv::MotifyResult rkv::ClientOperator::PutKeyValue(sharpen::NetStreamChannelPtr channel,sharpen::ByteBuffer key,sharpen::ByteBuffer value)
{
...
rkv::MotifyResult rkv::ClientOperator::DeleteKey(sharpen::NetStreamChannelPtr channel,sharpen::ByteBuffer key)
{
...
sharpen::Optional<sharpen::ByteBuffer> rkv::ClientOperator::Get(sharpen::ByteBuffer key,rkv::GetPolicy policy)
{
    char ip[21] ={};
    sharpen::NetStreamChannelPtr conn{nullptr};
    sharpen::IpEndPoint id;
...
rkv::MotifyResult rkv::ClientOperator::Put(sharpen::ByteBuffer key,sharpen::ByteBuffer value)
{
...
rkv::MotifyResult rkv::ClientOperator::Delete(sharpen::ByteBuffer key)
{
    rkv::MotifyResult result{rkv::MotifyResult::NotCommit};
    while (result == rkv::MotifyResult::NotCommit)
    {
